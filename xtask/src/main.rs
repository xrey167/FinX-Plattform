...
fn main() {
    ...
    let result = match command.as_str() {
        ...
        "new-provider" => new_provider::new_provider(args.next()),
...
#[allow(clippy::too_many_lines)] // single logical unit: one benchmark report rendered as markdown
