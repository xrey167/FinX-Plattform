...
"""Generated ``news`` router namespace for the FinX Platform SDK."""
...
class NewsNamespace:
    """Accessor for the ``news`` route namespace."""
    ...
    def company(
        ...
        **kwargs: object,
        ...
        """Symbol-filtered company news articles (benzinga).
        ...
        return self._client.fetch("news/company", params)
    ...
    def world(
        ...
        **kwargs: object,
        ...
        """General market / world news articles, no symbol filter (benzinga).
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("news/world", params)
