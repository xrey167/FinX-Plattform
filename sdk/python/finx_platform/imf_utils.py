...
"""Generated ``imf_utils`` router namespace for the FinX Platform SDK."""
...
class ImfUtilsNamespace:
    """Accessor for the ``imf_utils`` route namespace."""
    ...
    def get_dataflow_dimensions(
        ...
        **kwargs: object,
        ...
        Route: ``imf_utils/get_dataflow_dimensions``.
        ...
        return self._client.fetch("imf_utils/get_dataflow_dimensions", params)
    ...
    def list_dataflows(
        ...
        **kwargs: object,
        ...
        Route: ``imf_utils/list_dataflows``.
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("imf_utils/list_dataflows", params)
    ...
    def list_tables(
        ...
        **kwargs: object,
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("imf_utils/list_tables", params)
    ...
    def presentation_table(
        ...
        **kwargs: object,
        ...
        Route: ``imf_utils/presentation_table``.
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("imf_utils/presentation_table", params)
