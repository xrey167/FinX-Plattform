...
"""Generated ``uscongress`` router namespace for the FinX Platform SDK."""
...
class UscongressNamespace:
    """Accessor for the ``uscongress`` route namespace."""
    ...
    def bill_info(
        ...
        **kwargs: object,
        ...
        """Detailed metadata for a single US Congress bill (congress.gov, free key).
        ...
        return self._client.fetch("uscongress/bill_info", params)
    ...
    def bill_text_urls(
        ...
        **kwargs: object,
        ...
        """Downloadable text-version URLs for a US Congress bill (congress.gov, free key).
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("uscongress/bill_text_urls", params)
    ...
    def bills(
        ...
        **kwargs: object,
        ...
        """List US Congress bills for a congress and bill type (congress.gov, free key).
        ...
        if provider is not None:
            params["provider"] = provider
        return self._client.fetch("uscongress/bills", params)
