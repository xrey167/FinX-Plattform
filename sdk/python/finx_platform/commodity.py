...
"""Generated ``commodity`` router namespace for the FinX Platform SDK."""
...
class CommodityNamespace:
    ...
    def petroleum_status_report(
        ...
        **kwargs: object,
        ...
        """EIA Weekly Petroleum Status Report (WPSR) series rows.
        ...
        if chart:
            params["chart"] = "true"
        return self._client.fetch("commodity/petroleum_status_report", params)
    ...
    def short_term_energy_outlook(
        ...
        **kwargs: object,
        ...
        """EIA Short-Term Energy Outlook (STEO) series rows.
        ...
        if chart:
            params["chart"] = "true"
        return self._client.fetch("commodity/short_term_energy_outlook", params)
