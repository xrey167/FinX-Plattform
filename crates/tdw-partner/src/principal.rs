//! The shared persona / memory / trust seam (the partner design §6).
//!
...
pub struct TrustContext {
    ...
    /// (the partner design §3). The [`crate::ProposalQueue`] refuses writes below
...
/// The one identity per partner session (the partner design §6).
///
...
/// The surface-agnostic citation a turn emits (the partner design §1.2).
///
