# tdw-config Readiness Worksheet

Owner tranche: G002-core-contracts-event-session-and-replay-crates - Core Contracts, Event, Session, and Replay Crates.

## Baseline Inventory

- Manifest: crates\tdw-config\Cargo.toml
- Target kinds: lib
- Local dependencies: none
- External dependencies: schemars ^1.2.1; serde ^1.0.228 features=[derive]; serde_json ^1.0.145; thiserror ^2.0.18; toml ^1.1.2
- Dev dependencies: none
- Reverse local dependencies: tdw-llm, tdw-service-api, xtask
- Feature flags: none
...
- [x] Dependency direction reviewed: local dependencies are none; reverse dependencies are tdw-llm, tdw-service-api, xtask.
...
- Layer precedence, TOML ingestion, deep JSON merge, default permission stance, and schema export are typed and tested.
- No code change required in G002; existing errors preserve TOML/JSON source context.
- Follow-up boundary: Runtime path expansion remains a higher-level service/runtime responsibility.
