...
- [x] Scaffold, dead-code, and fallback signals classified: 4 current scan signals, all test-only panic assertions or accepted recording/in-memory follow-up boundaries; 0 bootstrap stub signals remain.
...
- Bootstrap stub was replaced with ParquetDatasetManifest and ParquetFile contracts.
- Manifest totals and file/manifest checksums are typed, serializable, and regression-tested.
- Follow-up boundary: actual parquet decoding/writing can use this manifest contract later.
