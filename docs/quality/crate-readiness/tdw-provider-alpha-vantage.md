# tdw-provider-alpha-vantage Readiness Worksheet
...
- Manifest: `C:\Users\ReyDa\FinX-Finance\FinX-Plattform-release-1-0-crate-audit\crates\tdw-provider-alpha-vantage\Cargo.toml`.
- Targets: lib, test.
- Features: default; http=[dep:async-trait,dep:bytes,dep:reqwest,dep:serde_json,dep:tdw-core,dep:tdw-domain,dep:tokio].
- Test attributes found in Rust sources: 15.
- Tests directory: True.
- Docs/examples: crate-readiness worksheet only.
- Scan signal files: 2.
- Related open PR coverage: Open PR #164 adds crate README, ARCHITECTURE, and example coverage.
