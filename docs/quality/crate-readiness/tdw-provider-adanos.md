# tdw-provider-adanos Readiness Worksheet
...
- Manifest: `C:\Users\ReyDa\FinX-Finance\FinX-Plattform-release-1-0-crate-audit\crates\tdw-provider-adanos\Cargo.toml`.
- Targets: lib, test.
- Features: default; http=[dep:async-trait,dep:bytes,dep:reqwest,dep:tdw-core,dep:tdw-domain,dep:tokio].
- Test attributes found in Rust sources: 33.
