# tdw-provider-ws Readiness Worksheet
...
- Manifest: `C:\Users\ReyDa\FinX-Finance\FinX-Plattform-release-1-0-crate-audit\crates\tdw-provider-ws\Cargo.toml`.
- Targets: lib.
- Features: default; ws=[dep:tokio-tungstenite,dep:tokio,dep:futures-util].
- Test attributes found in Rust sources: 5.
- Tests directory: False.
- Docs/examples: crate-readiness worksheet only.
- Scan signal files: 1.
- Related open PR coverage: Open PR #166 adds crate README, ARCHITECTURE, and example coverage.
