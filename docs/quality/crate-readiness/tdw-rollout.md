...
- Scaffold/dead-code/fallback scan signals: 5 total, 0 stub-related
...
- [x] Dependency direction reviewed: local dependencies are tdw-protocol; reverse dependencies are tdw-replay, tdw-service-api.
