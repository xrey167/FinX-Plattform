# tdw-backend Readiness Worksheet
...
- Manifest: `C:\Users\ReyDa\FinX-Finance\FinX-Plattform-release-1-0-crate-audit\crates\tdw-backend\Cargo.toml`.
- Targets: bin, example, lib, test.
- Features: default; google=[dep:tdw-embed-google,tdw-embed-google/http]; openai=[dep:tdw-embed-openai,tdw-embed-openai/http]; transport-http=[tdw-app-server/transport-http]; transport-uds=[tdw-app-server/transport-uds].
- Test attributes found in Rust sources: 38.
- Tests directory: True.
- Docs/examples: examples/.
- Scan signal files: 2.
- Related open PR coverage: Open PR #170 adds crate README, ARCHITECTURE, and example coverage.
