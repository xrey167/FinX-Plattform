...
- TableManifest now has typed validation for table name, version, files, file path, and checksum drift.
- Iceberg and Delta manifests remain represented by the same compact contract.
- Follow-up boundary: production manifest readers can plug into this validation contract.
