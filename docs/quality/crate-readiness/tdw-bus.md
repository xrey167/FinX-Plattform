...
- Bounded in-memory event bus preserves sequence ordering and now exposes retention-loss evidence.
- Added RetentionWindow, retention_window, has_retention_gap, and a capacity-eviction regression test.
- Follow-up boundary: Durable or distributed bus implementations remain outside this in-memory contract crate.
