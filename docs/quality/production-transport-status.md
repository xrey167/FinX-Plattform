...
1. **G012 remaining LLM/embedding adapters**: provider transports are complete; Anthropic, OpenAI-compatible batch HTTP, and OpenAI embeddings have landed, while Google embeddings and LLM SSE streaming remain.
